...
people=pd.read_csv('C:/LOCAL_PEOPLE_GU_2020.csv',encoding='euc-kr',index_col=False)
map_code=pd.read_csv('C:/법정동.csv',encoding='euc-kr',index_col=False)

people_data = people.drop(['기준일ID','시간대구분'],axis=1)
